...
**定义 1.1** (概率空间与分布 (Probability Spaces & Distributions)的基本概念): 
...
**公理系统A** (概率空间与分布 (Probability Spaces & Distributions)的公理化表述):
...
% 概率空间与分布 (Probability Spaces & Distributions)的形式化表示
...
// 概率空间与分布 (Probability Spaces & Distributions) - Rust实现
