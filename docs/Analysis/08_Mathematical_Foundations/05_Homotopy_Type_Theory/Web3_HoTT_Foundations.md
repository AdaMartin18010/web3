...
**定义 1.1** (Web3同伦类型论基础 (Homotopy Type Theory Foundations for Web3)的基本概念):
...
**公理系统A** (Web3同伦类型论基础 (Homotopy Type Theory Foundations for Web3)的公理化表述):
...
% Web3同伦类型论基础 (Homotopy Type Theory Foundations for Web3)的形式化表示
...
// Web3同伦类型论基础 (Homotopy Type Theory Foundations for Web3) - Rust实现
