...
**定义 1.1** (控制系统基础 (Control Systems Foundations)的基本概念):
...
**公理系统A** (控制系统基础 (Control Systems Foundations)的公理化表述):
...
% 控制系统基础 (Control Systems Foundations)的形式化表示
...
// 控制系统基础 (Control Systems Foundations) - Rust实现
