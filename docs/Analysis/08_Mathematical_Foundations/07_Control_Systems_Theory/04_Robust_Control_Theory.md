...
# 04_Robust_Control_Theory

## 1. 严格数学定义与公理化

### 1.1 基础概念定义

**定义 1.1** (04_Robust_Control_Theory的基本概念):
...
**公理系统A** (04_Robust_Control_Theory的公理化表述):
...
% 04_Robust_Control_Theory的形式化表示
...
// 04_Robust_Control_Theory - Rust实现
